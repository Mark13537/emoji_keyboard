...
class EmojiModel {
  ...
  EmojiModel._create({required this.filePath});

  static Future<EmojiModel> create({required String filePath}) async {
    // Call the private constructor
    var instance = EmojiModel._create(filePath: filePath);
